...
from app.api.routers import users, invaders, user_progress, auth, user_requests, admin_requests, upload, flash_import, apk, news, notifications, account, comments, custom_invaders
...
app.include_router(custom_invaders.router)
